...
package Gates is
  ...
  component MUX_2x1  is
	...
	component MUX_4x1  is
		port (I3,I2,I1,I0,S2,S1: in std_logic; Y: out std_logic);
   end component;
...
begin
  m1: MUX_2x1 port map(I1=>I1, I0=>I0, S=>S1, Y=>o1);
  m2: MUX_2x1 port map(I1=>I3, I0=>I2, S=>S1, Y=>o2);
  m3: MUX_2x1 port map(I0=>o1, I1=>o2, S=>S2, Y=>Y);
end Struct;
