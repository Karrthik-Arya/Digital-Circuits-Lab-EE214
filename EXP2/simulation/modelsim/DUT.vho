...
SIGNAL \scrabble_instance|g3|Y~combout\ : std_logic;
...
\scrabble_instance|g3|Y\ : maxv_lcell
-- Equation(s):
-- \scrabble_instance|g3|Y~combout\ = (\input_vector~combout\(0) & (!\input_vector~combout\(1) & (\input_vector~combout\(3) $ (!\input_vector~combout\(2))))) # (!\input_vector~combout\(0) & (\input_vector~combout\(1) & (\input_vector~combout\(3) $ 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \scrabble_instance|g3|Y~combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \scrabble_instance|g3|Y~combout\,
	oe => VCC,
